...
app.controller('DashboardCtrl',
	function ($scope, $rootScope, $mdDialog, $filter, $timeout, $location,
			  toastr, accountServices, locationService, dashboardService) {
		...
		$scope.fnCustomDialog = function (ev) {
			...
			$mdDialog.show({
				...
				'       <md-button class="md-raised md-accent" ng-click="fnGoTo()">Location Setup</md-button>' +
				'   </md-dialog-actions>' +
				'</md-dialog>'
